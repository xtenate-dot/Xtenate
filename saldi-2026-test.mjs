...
zet('xtenate_covers',[{id:243,artikel:'Voorbeeldartikel',voorraad:11}]);
zet('xtenate_hnvi',[{id:15,datum:'2026-02-05',omschr:'bestaand lot'}]);
zet('xtenate_maand_saldos_override',{'2022-09':{begin:100.00,eind:200.00}});
...
ok('bestaande maandsaldi van 2022 blijven staan',
   saldi['2022-09'] && saldi['2022-09'].eind===200.00, JSON.stringify(saldi['2022-09']));
