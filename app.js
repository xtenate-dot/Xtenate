...
import { nav, gaNaar, hertekenHuidigePagina, paginaUitHash } from './ui.js?v=20260821d';
import { wisselJaar, renderHome } from './dashboard.js?v=20260821d';
import { renderBank, openTxModal, closeTx, saveTx, syncTxGrootboek, bewerkBoeking, deleteTx } from './bank.js?v=20260821d';
import { renderFacturen, kiesFactuurTab } from './facturen-ui.js?v=20260821d';
import { renderBeheer } from './beheer.js?v=20260821d';
import { renderPortaal } from './home.js?v=20260821d';
import { renderGrootboek, wisFiltersGrootboek, openGrootboekRekening, sluitGrootboekRekening } from './grootboek.js?v=20260821d';
import { renderBelasting, openExtraKosten, openPercentages, openInkomenssoort, kopieerAangifte, downloadAangifte, downloadAangiftePdf } from './belasting.js?v=20260821d';
import { renderCrediteuren, wisselJaarCrediteuren } from './crediteuren.js?v=20260821d';
import { renderDebiteuren, wisselJaarDebiteuren } from './debiteuren.js?v=20260821d';
import {
...
} from './modals.js?v=20260821d';
import { initUiVoorkeuren, wisselThema, wisselMenu, wisselMobielMenu, sluitMobielMenu } from './theme.js?v=20260821d';
import { wisselNavGroep, initNavGroepen } from './navgroepen.js?v=20260821d';
import { initZoek, focusZoek, sluitZoek } from './search.js?v=20260821d';
import { openExportModal, sluitExportModal, toonExportSamenvatting, doeExport } from './excel-ui.js?v=20260821d';
import { openZelftestModal, sluitZelftestModal, startZelftest } from './zelftest-ui.js?v=20260821d';
import {
...
} from './migratie-ui.js?v=20260821d';
import {
...
} from './opslagdiagnose-ui.js?v=20260821d';
import {
...
} from './gegevenscontrole-ui.js?v=20260821d';
import {
  openUitvoeren, sluitUitvoeren, doeStapBackup, zetBegrepen, doeStapUitvoeren
} from './uitvoeren-ui.js?v=20260821d';
import { vertraag } from './helpers.js?v=20260821d';
import { toonBoeking, sluitDrawer, openBoeking } from './drawer.js?v=20260821d';
import { start as startAuth, login, uitloggen, opnieuwVerbinden } from './auth.js?v=20260821d';
...
Object.assign(window, {
  ...
  renderBelasting, openExtraKosten, openPercentages, openInkomenssoort, kopieerAangifte, downloadAangifte, downloadAangiftePdf,
