...
import { factuurSamenvatting } from './facturen.js?v=20260821y';
import { esc, fmt } from './helpers.js?v=20260821y';
import { STANDAARD_MIN_VOORRAAD, state } from './storage.js?v=20260821y';
