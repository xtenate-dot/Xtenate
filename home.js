...
import { draaiControles } from './controle.js?v=20260821s';
import { factuurSamenvatting } from './facturen.js?v=20260821s';
import { esc, fmt } from './helpers.js?v=20260821s';
import { STANDAARD_MIN_VOORRAAD, state } from './storage.js?v=20260821s';
