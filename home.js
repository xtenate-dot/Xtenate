...
import { factuurSamenvatting } from './facturen.js?v=20260821z';
import { esc, fmt } from './helpers.js?v=20260821z';
import { STANDAARD_MIN_VOORRAAD, state } from './storage.js?v=20260821z';
