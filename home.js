...
import { factuurSamenvatting } from './facturen.js?v=20260821m';
import { esc, fmt } from './helpers.js?v=20260821m';
import { STANDAARD_MIN_VOORRAAD, state } from './storage.js?v=20260821m';
