...
import { getClient, leesbareFout, testVerbinding } from './supabase.js?v=20260821p';
import { configProbleem, isGeconfigureerd } from './config.js?v=20260821p';
import { loadDataHybrid } from './storage.js?v=20260821p';
