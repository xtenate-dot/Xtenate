...
import { getClient, leesbareFout, testVerbinding } from './supabase.js?v=20260826a';
import { configProbleem, isGeconfigureerd } from './config.js?v=20260826a';
import { loadDataHybrid } from './storage.js?v=20260826a';
