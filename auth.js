...
import { getClient, leesbareFout, testVerbinding } from './supabase.js?v=20260820d';
import { configProbleem, isGeconfigureerd } from './config.js?v=20260820d';
import { loadDataHybrid } from './storage.js?v=20260820d';
