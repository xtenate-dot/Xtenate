...
import { bedragUit, ddmm, esc, fmt, leegVlak } from './helpers.js?v=20260821e';
import { maakSorteerbaar } from './tables.js?v=20260821e';
import { openApiKeyModal } from './modals.js?v=20260821e';
import { saveHnviData, state } from './storage.js?v=20260821e';
import { saveToSupabase, deleteFromSupabase, addToPendingQueue } from './supabase-client-v2.js?v=20260821e';
