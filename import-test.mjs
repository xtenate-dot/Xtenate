...
const covers=[{id:243,artikel:'Voorbeeldartikel',voorraad:11}];
const ms={'2022-09':{begin:100.00,eind:200.00}};
const ht={'2022':{omzet:1000.00,kosten:500.00,priveOp:250,priveSt:1000.00}};
...
ok('priveSt 2022 nog 1000.00',
   JSON.parse(localStorage.getItem('xtenate_home_totals_override'))['2022'].priveSt===1000.00);
