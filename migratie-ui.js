...
import { maakVolledigeReservekopie, beschikbareJaren } from './export.js?v=20260823a';
import { alsTekst, diagnose, diagnoseAlsTekst, dryRun } from './migratie.js?v=20260823a';
import { herstelPreview } from './herstel.js?v=20260823a';
