...
import { maakVolledigeReservekopie, beschikbareJaren } from './export.js?v=20260826d';
import { alsTekst, diagnose, diagnoseAlsTekst, dryRun } from './migratie.js?v=20260826d';
import { herstelPreview } from './herstel.js?v=20260826d';
