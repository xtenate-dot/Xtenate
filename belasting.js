...
import { charts, dc , palette } from './charts.js?v=20260828a';
import { GBNM, ddmm, fmt, gbCode, isInkomst, isOmzet, isUitgave } from './helpers.js?v=20260828a';
import { downloadModelPdf } from './pdf.js?v=20260828a';
