...
import { charts, dc , palette } from './charts.js?v=20260821h';
import { GBNM, ddmm, fmt, isInkomst, isOmzet, isUitgave } from './helpers.js?v=20260821h';
import { downloadModelPdf } from './pdf.js?v=20260821h';
